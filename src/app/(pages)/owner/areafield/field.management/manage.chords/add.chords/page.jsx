...
function AddBuildingForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Form validation
    let errors = {};
    if (!formData.building) errors.building = 'กรุณากรอกชื่อคอร์ด';
  ...
  return (
    <div className="page-container">
      ...
      <div className="form-container">
        <h2>เพิ่มข้อมูลคอร์ด</h2> {/* ตอนนี้ใส่ไปในกรอบเดียวกัน */}
        <form onSubmit={handleSubmit} className="form">
          <div className="form-group">
            <label htmlFor="building">ชื่อคอร์ด:</label>
            <input
              type="text"
              id="building"
              name="building"
